...
<div class="mc-field-group">
  <label for="mce-MMERGE4">Institution Name </label>
...
<li><input type="radio" value="other" name="MMERGE3" id="mce-MMERGE3-3"><label for="mce-MMERGE3-3">Other</label></li>
  ...
  <div id="mce-responses" class="clear">
    ...
    <div style="position: absolute; left: -5000px;"><input type="text" name="b_a04105bfca6c4cb8c24ff8680_ab7a9b8629" tabindex="-1" value=""></div>
